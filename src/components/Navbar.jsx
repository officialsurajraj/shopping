...
const Navbar = () => {
    ...
    return (
        <div className='flex items-center justify-between py-5 font-medium sticky top-0 bg-white'>
            <Link to={'/'}>
                <div className="flex items-center gap-2 mb-2 sm:text-xl">
            ...
            <div className='flex items-center gap-6'>
                ...
                <Link to='/cart' className='relative'>
                    ...
                    <p className='absolute right-[-5px] bottom-[-5px] w-4 text-center text-xs leading-4 bg-black text-white aspect-square rounded-full text-[-8px]'>{getCartCount()}</p>
                </Link>
            ...
            <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full' : 'w-0'}`}>
                <div className='flex flex-col text-gray-600'>
                    ...
                    <NavLink onClick={() => setVisible(false)} className='py-2 pl-6 border' to='/collectiom'>COLLECTION</NavLink>
